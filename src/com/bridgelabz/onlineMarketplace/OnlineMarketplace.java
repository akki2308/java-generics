...
public class OnlineMarketplace {
    public static void main(String[] args) {
        // Create products
        Product<BookCategory> book1 = new Product<>("Chota Bheem", 250, BookCategory.FICTION);
        Product<ClothingCategory> clothing1 = new Product<>("Shirt", 1500, ClothingCategory.MEN);
        Product<GadgetCategory> gadget1 = new Product<>("Mobile", 4521, GadgetCategory.MOBILE);
